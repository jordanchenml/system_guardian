"""
Test configuration file for system_guardian.

This module contains fixtures that are available to all tests.
"""
...
from system_guardian.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from system_guardian.db.meta import meta  # noqa: WPS433
    from system_guardian.db.models import load_all_models  # noqa: WPS433
