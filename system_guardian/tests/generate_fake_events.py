...
ISSUE_TEMPLATES = {
    ...
    "datadog": {
        "alert": [
            {
                "title": "[Triggered] Critical Error for overload cpu usage",
                "description": "Please check it.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/abcdef123456.png)](https://datadoghq.com/monitors/12345)\n\n**system.cpu.user** over ***** was **> 85%** on average during the **last 5m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 16:01:16 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/12345)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/12345/edit)]",
                "keywords": [
                    "cpu",
                    "overload",
                    "critical",
                ...
                "resolution": "Identified CPU-intensive process and optimized resource usage. Applied throttling to prevent future overloads.",
                "alert_id": "12345",
                "alert_status": "system.cpu.user over *** was > 85% on average during the last 5m**.",
                "alert_metric": "system.cpu.user",
            },
            {
                "title": "[Triggered] INCIDENT: Memory utilization exceeding threshold",
                "description": "Memory usage above 90% on database cluster.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/fedcba654321.png)](https://datadoghq.com/monitors/54321)\n\n**system.memory.used** over ***** was **> 90%** on average during the **last 10m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 16:05:22 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/54321)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/54321/edit)]",
                "keywords": [
                    "memory",
                    "database",
                    "threshold",
                ...
                "alert_id": "54321",
                "alert_status": "system.memory.used over *** was > 90% on average during the last 10m**.",
                "alert_metric": "system.memory.used",
            },
            {
                "title": "[Triggered] OUTAGE: API response time above threshold",
                "description": "API endpoints experiencing high latency.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/123abc456def.png)](https://datadoghq.com/monitors/67890)\n\n**api.response.time** over ***** was **> 2s** on average during the **last 15m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 15:55:10 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/67890)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/67890/edit)]",
                "keywords": [
                    "api",
                    "response",
                    "time",
                ...
                "alert_id": "67890",
                "alert_status": "api.response.time over *** was > 2s on average during the last 15m**.",
                "alert_metric": "api.response.time",
            },
        ],
        "metric_alert": [
            {
                "title": "[Triggered] URGENT: Disk space nearly full on production servers",
                "description": "Disk usage exceeded 95% on multiple servers.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/456def789ghi.png)](https://datadoghq.com/monitors/98765)\n\n**system.disk.used** over ***** was **> 95%** on average during the **last 30m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 16:30:45 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/98765)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/98765/edit)]",
                "keywords": [
                    "disk",
                    "space",
                    "full",
                ...
                "resolution": "Removed old log files and temporary data. Implemented log rotation policy and added monitoring for disk space trends.",
                "alert_id": "98765",
                "alert_status": "system.disk.used over *** was > 95% on average during the last 30m**.",
                "alert_metric": "system.disk.used",
            },
            {
                "title": "[Triggered] BROKEN: Network packet loss detected",
                "description": "High packet loss rates affecting service connectivity.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/789ghi123jkl.png)](https://datadoghq.com/monitors/43210)\n\n**network.packets.loss_percent** over ***** was **> 5%** on average during the **last 5m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 17:15:33 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/43210)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/43210/edit)]",
                "keywords": [
                    "network",
                    "packet",
                    "loss",
                ...
                "resolution": "Identified network hardware issue causing intermittent packet loss. Replaced faulty network interface and rebalanced traffic.",
                "alert_id": "43210",
                "alert_status": "network.packets.loss_percent over *** was > 5% on average during the last 5m**.",
                "alert_metric": "network.packets.loss_percent",
            },
        ],
        "service_check": [
            {
                "title": "[Triggered] High volume of HTTP 5xx errors detected",
                "description": "Multiple services returning HTTP 500 errors.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/111aaa222bbb.png)](https://datadoghq.com/monitors/11111)\n\n**http.error_rate** over ***** was **> 10%** on average during the **last 15m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 14:22:18 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/11111)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/11111/edit)]",
                "keywords": [
                    "http",
                    "error",
                    "5xx",
                ...
                "resolution": "Fixed error handling in API gateway and added retry logic for transient errors.",
                "alert_id": "11111",
                "alert_status": "http.error_rate over *** was > 10% on average during the last 15m**.",
                "alert_metric": "http.error_rate",
            },
        ],
        "event": [
            {
                "title": "[Triggered] Database failover detected",
                "description": "Automatic database failover occurred.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/222bbb333ccc.png)](https://datadoghq.com/monitors/22222)\n\n**database.failover.count** was **> 0** in the **last 5m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 13:45:30 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/22222)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/22222/edit)]",
                "keywords": [
                    "database",
                    "failover",
                    "high",
                ...
                "resolution": "Investigated root cause of database failover. Applied configuration change to prevent unnecessary failovers.",
                "alert_id": "22222",
                "alert_status": "database.failover.count was > 0 in the last 5m.",
                "alert_metric": "database.failover.count",
            },
        ],
        "monitor": [
            {
                "title": "[Triggered] Low application response rate detected",
                "description": "Application requests per second dropped significantly.\n@webhook-Test @webhook-SystemGuardian\n\n[![Metric Graph](https://p.datadoghq.com/snapshot/view/dd-snapshots-prod/org_123456/2025-03-26/333ccc444ddd.png)](https://datadoghq.com/monitors/33333)\n\n**app.requests.per_second** was **< 10** on average during the **last 10m**.\n\nThe monitor was last triggered at Wed Mar 26 2025 12:10:45 UTC.\n\n- - -\n\n[[Monitor Status](https://datadoghq.com/monitors/33333)] \u00b7 [[Edit Monitor](https://datadoghq.com/monitors/33333/edit)]",
                "keywords": [
                    "application",
                    "response",
                    "rate",
                ...
                "resolution": "Found traffic routing issue and corrected load balancer configuration.",
                "alert_id": "33333",
                "alert_status": "app.requests.per_second was < 10 on average during the last 10m.",
                "alert_metric": "app.requests.per_second",
            },
        ],
    },
}
...
def generate_raw_payload(
    ...
    if source == "github":
        ...
        # 取得datadog模板
        template_event = random.choice(
            ISSUE_TEMPLATES.get(source, {}).get(event_type, []),
        )

        # 生成隨機alert ID
        alert_id = template_event.get("alert_id", str(random.randint(1000000, 9999999)))

        # 從模板中獲取或生成所需的欄位
        alert_status = template_event.get(
            "alert_status", f"System metric was above threshold during the last 5m.",
        )
        alert_metric = template_event.get("alert_metric", "system.cpu.user")

        # 生成alert標題，若不是以[Triggered]開頭，則添加
        alert_title = template_event.get("title", title)
        if not alert_title.startswith("[Triggered]"):
            alert_title = f"[Triggered] {alert_title}"

        # 從模板中獲取或生成說明文字
        alert_text = template_event.get("description", description)

        # 生成時間戳
        current_ts = int(datetime.datetime.now().timestamp() * 1000)

        # 生成datadog對應格式的payload
        payload = {
            "alerts": [
                {
                    "title": alert_title,
                    ...
                    "alert_tags": "monitor",
                    "alert_created_at": current_ts,
                    "alert_updated_at": current_ts,
                    "org_id": "1300471879",
                    "org_name": "UTO",
                    "host": random.choice(
                        [
...
async def send_event_to_api(
    ...
    if source == "jira":
        ...
        # For Datadog events, send the entire alerts payload
        api_payload = event["raw_payload"]
    else:
    ...
    if source == "github":
        ...
        # For Datadog, add the event type as a header
